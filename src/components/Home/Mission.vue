<template>
  <div>
    ...
    <div class="mapbanContain">
      ...
      <img id="iphone" src="../../assets/pics/iphone.png">
      <div class="thai onbanner">
        <h2>ใช้งานได้เลย
          <br>ไม่ต้องติดตั้งอุปกรณ์
        </h2>
        <p>
          แค่ลงทะเบียนแล้วทำตามขั้นตอน
          คุณก็สามารถติดตามรถรับส่งของคุณได้ง่ายๆ
          ผ่านมือถือของผู้ขับ
        </p>
      </div>
    </div>
